...
#define MOVEMENT_ACTION_FACE_SOUTHWEST                  0xAE
#define MOVEMENT_ACTION_FACE_SOUTHEAST                  0xAF
#define MOVEMENT_ACTION_FACE_NORTHWEST                  0xB0
#define MOVEMENT_ACTION_FACE_NORTHEAST                  0xB1
#define MOVEMENT_ACTION_JUMP_2_SOUTHWEST                0xB2
#define MOVEMENT_ACTION_JUMP_2_SOUTHEAST                0xB3
#define MOVEMENT_ACTION_JUMP_2_NORTHWEST                0xB4
#define MOVEMENT_ACTION_JUMP_2_NORTHEAST                0xB5
#define MOVEMENT_ACTION_WALK_FAST_SOUTHWEST             0xB6
#define MOVEMENT_ACTION_WALK_FAST_SOUTHEAST             0xB7
#define MOVEMENT_ACTION_WALK_FAST_NORTHWEST             0xB8
#define MOVEMENT_ACTION_WALK_FAST_NORTHEAST             0xB9
#define MOVEMENT_ACTION_WALK_IN_PLACE_SLOW_SOUTHWEST    0xBA
#define MOVEMENT_ACTION_WALK_IN_PLACE_SLOW_SOUTHEAST    0xBB
#define MOVEMENT_ACTION_WALK_IN_PLACE_SLOW_NORTHWEST    0xBC
#define MOVEMENT_ACTION_WALK_IN_PLACE_SLOW_NORTHEAST    0xBD
#define MOVEMENT_ACTION_WALK_IN_PLACE_NORMAL_SOUTHWEST  0xBE
#define MOVEMENT_ACTION_WALK_IN_PLACE_NORMAL_SOUTHEAST  0xBF
#define MOVEMENT_ACTION_WALK_IN_PLACE_NORMAL_NORTHWEST  0xC0
#define MOVEMENT_ACTION_WALK_IN_PLACE_NORMAL_NORTHEAST  0xC1
#define MOVEMENT_ACTION_WALK_IN_PLACE_FAST_SOUTHWEST    0xC2
#define MOVEMENT_ACTION_WALK_IN_PLACE_FAST_SOUTHEAST    0xC3
#define MOVEMENT_ACTION_WALK_IN_PLACE_FAST_NORTHWEST    0xC4
#define MOVEMENT_ACTION_WALK_IN_PLACE_FAST_NORTHEAST    0xC5
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTEST_SOUTHWEST 0xC6
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTEST_SOUTHEAST 0xC7
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTEST_NORTHWEST 0xC8
#define MOVEMENT_ACTION_WALK_IN_PLACE_FASTEST_NORTHEAST 0xC9
#define MOVEMENT_ACTION_WALK_FASTEST_SOUTHWEST          0xCA
#define MOVEMENT_ACTION_WALK_FASTEST_SOUTHEAST          0xCB
#define MOVEMENT_ACTION_WALK_FASTEST_NORTHWEST          0xCC
#define MOVEMENT_ACTION_WALK_FASTEST_NORTHEAST          0xCD
#define MOVEMENT_ACTION_PLAYER_RUN_SOUTHWEST            0xCE
#define MOVEMENT_ACTION_PLAYER_RUN_SOUTHEAST            0xCF
#define MOVEMENT_ACTION_PLAYER_RUN_NORTHWEST            0xD0
#define MOVEMENT_ACTION_PLAYER_RUN_NORTHEAST            0xD1
#define MOVEMENT_ACTION_RIDE_WATER_CURRENT_SOUTHWEST    0xD2
#define MOVEMENT_ACTION_RIDE_WATER_CURRENT_SOUTHEAST    0xD3
#define MOVEMENT_ACTION_RIDE_WATER_CURRENT_NORTHWEST    0xD4
#define MOVEMENT_ACTION_RIDE_WATER_CURRENT_NORTHEAST    0xD5
#define MOVEMENT_ACTION_JUMP_SOUTHWEST                  0xD6
#define MOVEMENT_ACTION_JUMP_SOUTHEAST                  0xD7
#define MOVEMENT_ACTION_JUMP_NORTHWEST                  0xD8
#define MOVEMENT_ACTION_JUMP_NORTHEAST                  0xD9
#define MOVEMENT_ACTION_JUMP_IN_PLACE_SOUTHWEST         0xDA
#define MOVEMENT_ACTION_JUMP_IN_PLACE_SOUTHEAST         0xDB
#define MOVEMENT_ACTION_JUMP_IN_PLACE_NORTHWEST         0xDC
#define MOVEMENT_ACTION_JUMP_IN_PLACE_NORTHEAST         0xDD
#define MOVEMENT_ACTION_JUMP_IN_PLACE_SOUTHWEST_NORTHEAST 0xDE
#define MOVEMENT_ACTION_JUMP_IN_PLACE_SOUTHEAST_NORTHWEST 0xDF
#define MOVEMENT_ACTION_JUMP_IN_PLACE_NORTHWEST_SOUTHEAST 0xE0
#define MOVEMENT_ACTION_JUMP_IN_PLACE_NORTHEAST_SOUTHWEST 0xE1
#define MOVEMENT_ACTION_JUMP_SPECIAL_SOUTHWEST          0xE2
#define MOVEMENT_ACTION_JUMP_SPECIAL_SOUTHEAST          0xE3
#define MOVEMENT_ACTION_JUMP_SPECIAL_NORTHWEST          0xE4
#define MOVEMENT_ACTION_JUMP_SPECIAL_NORTHEAST          0xE5
