...
void MovementType_Encounter(struct Sprite *);
...
u8 MovementType_Encounter_Search(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_Encounter_WanderMove(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_Encounter_WanderExec(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_Encounter_WanderPause(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_Encounter_TrackEmote(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_Encounter_TrackMove(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_Encounter_TrackExec(struct ObjectEvent *objectEvent, struct Sprite *sprite);
u8 MovementType_Encounter_TrackPause(struct ObjectEvent *objectEvent, struct Sprite *sprite);
